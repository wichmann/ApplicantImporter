 ...
 * fields must not be empty for a valid Applicant.
 * <p>
 * Every Enum element stores the type of the associated value in the Applicant class. Some utility methods are provided to get the type for
 * a specific data field and to cast its values.
 * 
...
public enum DataField {
	...
	/**
	 * Ausbildungsbeginn. Stored as String object containing a valid date in the format "dd.mm.yyyy".
	 */
	 ...
	 * 
	 * 0 = ohne Angabe, 1 = evangelisch, 2 = römisch-katholisch, 3 = alevitisch, 4 = islamisch, 5 = sonstige, 6 = keine
	 */
	...
	/**
	 * Type of school that has been attended last before applying. Should only be used if the value of SCHOOL is SONSTIGES!
	 */
	SCHOOL_OTHER_TYPE(String.class, "Sonstige Schule", false),

	/**
	 * Specialization of given school type that has been attended before. Currently only used for Berufsfachschulen.
	 */
	...
	DataField(Class<?> classType, String description, boolean isRequired) {
	...
	/**
	 * Gets the type for a specific data field. The associated type is stored inside the Enum to allow correct casts of the return value of
	 * Applicant's getValue() method.
	 * <p>
	 * <b>Example:</b>
	 * <p>
	...
	/**
	 * Returns whether this data field is required for all valid applicants. All required fields MUST not be empty!
	 * 
	...
	/**
	 * Gets the value from given Applicant for this Enum element. The returned element is cast to the type that the compiler decides by type
	 * inference from the left-hand value at the calling code.
	 * 
	 * @param applicant
	...
	/**
	 * Returns a describing label for this data field. The returned string contains the description in German.
	 * 
